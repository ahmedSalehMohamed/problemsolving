...
const {revArrayInPlace}=require("./revArrayInPlace")
...
//console.log(reverseArray([2,3,4,6,4,7]));
//console.log(revArrayInPlace([1,8,6]));
//console.log("Palindrome is",checkPalindrome("madem"));
